package com.doubleclick.kalert;
...
import com.doubleclick.progresswheel.ProgressWheel;
...
public class KAlertDialog extends AlertDialog implements View.OnClickListener {
    ...
    private int titleColor = 0, contentColor = 0,
            confirmTextColor = android.R.color.white, cancelTextColor = android.R.color.black;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setConfirmText(mConfirmText, null /*ContextCompat.getDrawable(context, R.drawable.button_background)*/);
    ...
    */
    ...
    public KAlertDialog setConfirmClickListener(String text, Drawable bg, KAlertClickListener listener) {
        //noinspection deprecation
        setConfirmText(text, bg);
        mConfirmClickListener = listener;
        return this;
    }
    ...
    public KAlertDialog setConfirmText(String text, Drawable bg) {
        mConfirmText = text;
        if (mConfirmButton != null && mConfirmText != null) {
            showConfirmButton(true);
            mConfirmButton.setText(mConfirmText);
            mConfirmButton.setTextColor(ContextCompat.getColor(context, confirmTextColor));
            mConfirmButton.setBackgroundDrawable(bg);
        }
        return this;
    }
