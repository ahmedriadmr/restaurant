package com.doubleclick.rovleapp.feature.shop.content
...
@AndroidEntryPoint
class SortFragment : BaseFragment(R.layout.fragment_content) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        init()
        observeOrNull(viewModel.allProductsSorted, ::renderState)
    }
    ...
    fun setupSwipeRefresh(swipeRefreshLayout: SwipeRefreshLayout) {
        ...
        swipeRefresh.setOnRefreshListener {
            ...
            resetData()
            page?.let { viewModel.getAllProductsSorted(page = it, isRefresh = true) }
        }
    }
    ...
    private val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (shouldPaginate) {
                page?.let { viewModel.getAllProductsSorted(page = it, isRefresh = false) }
                isScrolling = false
            }
        }
