...
class PresentationListAdapter : ListAdapter<Presentation, PresentationListAdapter.ViewHolder>(Differ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ViewHolder(parent.inflate(R.layout.layout_item_package_in_list_cart))

    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) =
        viewHolder.bind(getItem(position), plusListener, minusListener)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(
            ...
            totalPricePerItem.text = itemView.context.getString(R.string.total_price_per_item,
            ...
            units.text = itemView.context.getString(R.string.units_text_, item.units)
