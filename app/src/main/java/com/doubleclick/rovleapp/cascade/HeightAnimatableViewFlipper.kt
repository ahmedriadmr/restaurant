...
import com.doubleclick.cascade.internal.ForcePaddingsDrawable
import com.doubleclick.cascade.internal.ViewFlipper2
...
open class HeightAnimatableViewFlipper(context: Context) : ViewFlipper2(context) {
    ...
    private var clipBounds2: Rect? =
        null // Because View#clipBounds creates a new Rect on every call.
