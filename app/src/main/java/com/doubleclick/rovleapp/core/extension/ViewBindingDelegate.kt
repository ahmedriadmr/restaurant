...
fun <T : ViewBinding> androidx.fragment.app.Fragment.viewBinding(factory: (View) -> T): ReadOnlyProperty<androidx.fragment.app.Fragment, T> =
    object : ReadOnlyProperty<androidx.fragment.app.Fragment, T>, DefaultLifecycleObserver {
...
inline fun <T : ViewBinding> androidx.fragment.app.DialogFragment.viewBinding(crossinline factory: (LayoutInflater) -> T) =
    lazy(LazyThreadSafetyMode.NONE) {
        factory(layoutInflater)
    }
